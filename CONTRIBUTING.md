# Contributing to job-and-task-archiver

Thank you for your interest in contributing to the job-and-task-archiver project! This document provides guidelines and instructions for contributing to this project.
...
1. **Fork and clone the repository:**
   ```bash
   git clone https://github.com/YOUR-USERNAME/job-and-task-archiver.git
   cd job-and-task-archiver
   ```

2. **Add the upstream remote:**
   ```bash
   git remote add upstream https://github.com/itential/job-and-task-archiver.git
   ```
...
Thank you for contributing to job-and-task-archiver!
